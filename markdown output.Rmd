---
title: "Q method findings report"
author: "Sara Nawaz"
date: "4/6/2020"
...
# Cattle case
## Determine number of factors for cattle case
```{r echo=FALSE}
...
```{r echo=FALSE}
## Conduct Q analysis for cattle case
...
# Tomato case
## Determine number of factors for tomato case
```{r echo=FALSE}
### load tomato dataset #########################################################################
...
## Conduct Q analysis for tomato case
...
nfactors.tomato <- ncol(results.tomato$zsc)
col.order.tomato <- as.vector(rbind(1:nfactors.tomato, (1:nfactors.tomato)+nfactors.tomato))
scores.tomato <- scores.tomato[col.order.tomato]
...
# Fruit flies case
## Determine number of factors for fruit flies case
...
## Conduct Q analysis for fruit flies case
```{r echo=FALSE}
### conduct basic Q analysis ######################################################################
...
col.order.ff <- as.vector(rbind(1:nfactors.ff, (1:nfactors.ff)+nfactors.ff))
scores.ff <- scores.ff[col.order.ff]
...
# Wheat case
## Determine number of factors for wheat case
```{r echo=FALSE}
### load wheat dataset #########################################################################
...
## Conduct Q analysis for wheat case
```{r echo=FALSE}
### conduct basic Q analysis ######################################################################
...
col.order.wheat <- as.vector(rbind(1:nfactors.wheat, (1:nfactors.wheat)+nfactors.wheat))
scores.wheat <- scores.wheat[col.order.wheat]
